...
class SecurityManifestPusher:
    ...
    def cosign_get_existing_attestation(self, image_ref: str, output_file: str) -> bool:
        """
    ...
    def cosign_attest_security_manifest(self, security_manifest_path: str, image_ref: str):
        """
    ...
    def merge_and_push_security_manifest(
        ...
        for repo in destination_repos:
            ...
            attestation_exist = self.cosign_get_existing_attestation(image_ref, attestation_file)
            ...
            self.cosign_attest_security_manifest(full_security_manifest_path, image_ref)

    def get_source_item_security_manifest(
    ...
    def push_item_security_manifests(self, item: object):
        ...
        with tempfile.TemporaryDirectory(prefix="security_manifest_") as tmp_dir:
            if is_source_image:
                digest_manifests = self.get_source_item_security_manifest(item, tmp_dir)
    ...
    def push_security_manifests(self):
        ...
        default_authfile = os.environ.get("DEFAULT_DOCKER_AUTHFILE_PATH", "/.docker/config.json")
