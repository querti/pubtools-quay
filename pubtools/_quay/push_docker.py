...
class PushDocker:
    ...
    def run(self):
        ...
        # Generate and push security manifests
        security_manifest_pusher = SecurityManifestPusher(docker_push_items, self.target_settings)
        security_manifest_pusher.push_security_manifests()
